<x-app-layout>
    ...
    <ul class="flex">
        <li class="mr-6">
            <a class="text-blue-500 hover:text-blue-800" href="#">通知</a>
        </li>
        <li class="mr-6">
            <a class="text-blue-500 hover:text-blue-800" href="{{ url('add_friend_page') }}">友達追加</a>
        </li>
        <li class="mr-6">
            <a class="text-blue-500 hover:text-blue-800　type="button" data-modal-target="crypto-modal"
                    ...
                    <tbody>
                        <tr>
                            <td class="border-emerald-950 border px-4 py-2"><img src="" alt=""></td>
                                <td class="border-emerald-950 border px-4 py-2 w-48"><a href="{{ url('talk_room', $list->user_id) }}">{{ $list->user_name }}</a>
                                </td>
                                <td class="border-emerald-950 border px-4 py-2"></td>
                            </tr>
                    </tbody>
                </table>
            @else
                <table class="border-emerald-950 table-auto">
                    <tbody>
                        <tr>
                            <td class="border-emerald-950 border px-4 py-2"><img src="" alt=""></td>
                            <td class="border-emerald-950 border px-4 py-2 w-48">{{ $list->name }}</td>
                            <td class="border-emerald-950 border px-4 py-2"></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6">
                    ...
                    <ul class="my-4 space-y-3">
                        <li>
                            <a href="{{ url('profile_setting_page') }}"
